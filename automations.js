...
export const automations = [
	...
	},
	{
		...
		switches: [ 'switch.garage_lights', 'switch.garage_stereo', 'switch.breezeway_lights' ],
		allDay: true,
	},
	{
		name: 'Garage Far',
	...
	},
	{
		...
		switches: [ 'light.stairwell_light', 'light.stairtop_lights' ],
	},
	{
		name: 'Bar and Game Nook and Stairwell',
		sensors: [ 'binary_sensor.bar_ecolink_n2_motion_detection', 'binary_sensor.game_nook_ecolink_r4_sensor_state_any' ],
		switches: [ 'light.stairwell_light', 'switch.bar_lights', 'light.blue_room_light', 'light.blue_room_lamp', 'light.qbr_lamp', 'light.qbr_lamp', 'switch.tv_lamps' ],
	},
	{
		name: 'Nook',
